...
class _FormPageState extends State<FormPage> {
  ...
  void validarDados(){
    if(_controladorNome.text.isNotEmpty && _controladorCpf.text.isNotEmpty && _controladorContato.text.isNotEmpty){
      print('${_controladorNome} - ${_controladorContato} - ${_controladorContato}');
    }
  }
